...
public class NewLiferayPluginProjectOpMethods
{
    ...
    public static void updateLocation( final NewLiferayPluginProjectOp op, final Path baseLocation )
    {
        ...
        final Path newLocation =
            baseLocation.append( op.getProjectName().content() + ( suffix == null ? StringPool.EMPTY : suffix ) );
        op.setLocation( newLocation );
    }

    private static String getPluginTypeSuffix( final PluginType pluginType )
    {
        String suffix = null;
