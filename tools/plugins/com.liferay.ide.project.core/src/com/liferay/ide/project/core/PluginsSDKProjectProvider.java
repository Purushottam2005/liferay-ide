...
public class PluginsSDKProjectProvider extends AbstractLiferayProjectProvider
{
    ...
    public IStatus createNewProject( Object operation, IProgressMonitor monitor ) throws CoreException
    {
        ...
        final String projectName = op.getProjectName().content();// + getPluginTypeSuffix( pluginType );
        ...
        final boolean separateJRE = op.getUseDefaultLocation().content( true );
        ...
        {
            workingDir = sdk.getLocation().toOSString();
        }
        ...
        switch( pluginType )
        {
            case portlet:
                ...
                baseDir = sdk.getLocation().append( ISDKConstants.PORTLET_PLUGIN_PROJECT_FOLDER ).toOSString();
            ...
            case hook:
                baseDir = sdk.getLocation().append( ISDKConstants.HOOK_PLUGIN_PROJECT_FOLDER ).toOSString();
            ...
            case ext:
                baseDir = sdk.getLocation().append( ISDKConstants.EXT_PLUGIN_PROJECT_FOLDER ).toOSString();
            ...
            case layouttpl:
                baseDir = sdk.getLocation().append( ISDKConstants.LAYOUTTPL_PLUGIN_PROJECT_FOLDER ).toOSString();
            ...
            case theme:
                baseDir = sdk.getLocation().append( ISDKConstants.THEME_PLUGIN_PROJECT_FOLDER ).toOSString();
        ...
        final Path projectLocation = op.getLocation().content( true );
        ...
        final IProject newProject =
            ProjectUtil.importProject(
                projectRecord, getFacetRuntime( runtime ), sdk.getLocation().toOSString(), op, monitor );
